...
export function WhatsappFab() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 inline-flex items-center gap-2 rounded-full bg-whatsapp px-4 py-3 font-display text-sm font-semibold text-white shadow-[0_12px_32px_rgba(37,211,102,0.45)] transition-transform hover:scale-105 md:bottom-8 md:right-8"
    >
