...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ATDB Trade International — Heavy Equipment Rental in Bangladesh" },
    ...
    links: [
      ...
      { rel: "author", href: "https://behance.net/saazidhossain" },
    ],
    scripts: [
      {
          ...
          "@graph": [
            {
              ...
              alternateName: "M/S ATDB Trade International",
              foundingDate: "2000",
              description:
                "Bangladesh's premier heavy equipment rental partner — cranes, road rollers, excavators, support equipment.",
              areaServed: { "@type": "Country", name: "Bangladesh" },
              address: [
                { "@type": "PostalAddress", addressLocality: "Dhaka", addressCountry: "BD" },
                { "@type": "PostalAddress", addressLocality: "Tangail", addressCountry: "BD" },
              ],
              creator: {
                "@type": "Person",
                "@id": "https://behance.net/saazidhossain#person",
                name: "Sazid Hossain",
                alternateName: "সাজিদ হোসেন",
                jobTitle: "Architect & Digital Designer",
                url: "https://behance.net/saazidhossain",
                sameAs: ["https://behance.net/saazidhossain"],
                brand: { "@type": "Brand", name: "A SAZID HOSSAIN ARCHITECTURE" },
              },
            },
            {
              "@type": "WebSite",
              ...
              name: "ATDB Trade International",
              publisher: { "@id": "#org" },
              creator: { "@id": "https://behance.net/saazidhossain#person" },
              inLanguage: ["en", "bn"],
            },
          ],
        }),
